...
const shadowHeader = () => {
    ...
    //Add a class if the bottom offset is greator than 50 of the viewport
...
const contactForm = document.getElementById('contact-form'),
    ...
    emailjs.init('O6LGPHaYK-by5TtDE')

    const sendEmail = (e) => {
    e.preventDefault()
    emailjs.sendForm('service_nknzj5a','template_g0li3wa','#contact-form')
    .then(() => {
